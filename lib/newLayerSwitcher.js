...
OpenLayers.Control.newLayerSwitcher =
  ...
  // DOM Elements
    ...
    onInputClick: function(e) {
        if (!this.inputElem.disabled) {
            if (this.inputElem.type == "radio") {
				...
				// Hér breytum viðbakgrunnslit á korti eftir hvaða kort er í grunn
				 // Myndkortið
				if(this.layer.name == "Myndkort")
				{
					$j("#map").css("background-color","#284C6E");
				}
				//Skyggt kort án labela
				else if(this.layer.name == "Lighsaber sanstext") 
				{
					$j("#map").css("background-color","#95ACC0");
				}
	            //Skyggt kort
	            else if (this.layer.name == "Lighsaber") 
                {
                    $j("#map").css("background-color", "#95ABC0");
	            }				
				else if(this.layer.name == "Gr��urkort" || this.layer.name == "SPOT Gervitunglamyndir")
				{
					$j("#map").css("background-color","#ffffff");
				}				
				else if(this.layer.name == "Atlaskort LM�")
				{
					$j("#map").css("background-color","#000000");
				}
				else
				{
					$j("#map").css("background-color","#284C6E");
    ...
    showControls: function(minimize) {
        ...
        this.layersDiv.style.display = minimize ? "none" : "block";
    },
    ...
    loadContents: function() {
        ...
        this.layersDiv.className = this.displayClass + 'Layer';

        this.baseLbl = document.createElement("div");
        this.baseLbl.innerHTML = OpenLayers.i18n("baseLayer");
        this.baseLbl.className = this.displayClass + 'BaseLabel';

        this.baseLayersDiv = document.createElement("div");
        this.baseLayersDiv.className = this.displayClass + 'BaseLayer';
        ...
        */
        ...
        this.dataLbl.className = this.displayClass + 'DataLabel';

        this.dataLayersDiv = document.createElement("div");
        this.dataLayersDiv.className = this.displayClass + 'DataLayer';
