...
function doShare(){
    ...
    strHTML += "<div class='sendMailMessageDiv'><div><b>Skilaboð:</b></div><div><textarea class='sendMailMessage' id='sendMailMessageSendMail'>"+ linkur_text +"</textarea><div></div>";
    ...
    strHTML += "</div>";      
    $j("#modalpopup").html(strHTML);*/ // getEmailText
