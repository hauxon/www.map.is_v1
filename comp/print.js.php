...
function preparePrint(){
    ...
    $j("#searchInputString").css( "visibility", "hidden");
...
function cleanupPrint(){
    ...
    $j("#searchInputString").css( "visibility", "visible");
...
function preparePrint2(){
    ...
    $j("#olControlOverviewMapMaximizeButton_innerImage_chooser").css( "visibility", "hidden");   
    $j("#header_shadow").css( "visibility", "hidden");
    //$j("body").css("background-color", "#FFFFFF"); background-color:#EFF0F1;
    $j("body").css("background-color", "#EFF0F1");
    $j("#RoutingResultsDIV").css( "visibility", "hidden");
    $j("#LSHeaderDiv").css( "visibility", "hidden");
...
function cleanupPrint2(){
   ...
   // Hér er hreinsað eftir prentun í sama glugga
    ...
    $j("#LSHeaderDiv").css( "visibility", "visible");
